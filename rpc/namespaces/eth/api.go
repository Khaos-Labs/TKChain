...
import (
	...
	"github.com/Khaos-Labs/tkchain/crypto/ethsecp256k1"
	"github.com/Khaos-Labs/tkchain/crypto/hd"
	"github.com/Khaos-Labs/tkchain/rpc/backend"
	rpctypes "github.com/Khaos-Labs/tkchain/rpc/types"
	ethermint "github.com/Khaos-Labs/tkchain/types"
	"github.com/Khaos-Labs/tkchain/utils"
...
func (api *PublicEthereumAPI) doCall(
	...
	// convert the pending transactions into tkchain msgs
	if blockNum == rpctypes.PendingBlockNumber {
...
func (api *PublicEthereumAPI) GetProof(address common.Address, storageKeys []string, block rpctypes.BlockNumber) (*rpctypes.AccountResult, error) {
	...
	return &rpctypes.AccountResult{
		...
		StorageHash:  common.Hash{}, // Tkchain doesn't have a storage hash
...
// those transactions into tkchain messages.
