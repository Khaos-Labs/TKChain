...
See the Tkchain [JSON-RPC docs](https://docs.tkchain.zone/basics/json_rpc.html) for reference.

## Documentation and Specification

* Tkchain documentation: [https://docs.tkchain.zone](https://docs.tkchain.zone)
