// This is a test utility for Tkchain's Web3 JSON-RPC services.
//
// To run these tests please first ensure you have the tkchaind running
// and have started the RPC service with `tkchaincli rest-server`.
//
