...
import (
	...
	"github.com/Khaos-Labs/tkchain/app"
	ante "github.com/Khaos-Labs/tkchain/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, abci.Header{Height: 1, ChainID: "tkchain-3", Time: time.Now().UTC()})
