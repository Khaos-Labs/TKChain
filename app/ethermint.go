...
import (
	...
	"github.com/Khaos-Labs/tkchain/app/ante"
	ethermintcodec "github.com/Khaos-Labs/tkchain/codec"
	ethermint "github.com/Khaos-Labs/tkchain/types"
	"github.com/Khaos-Labs/tkchain/x/evm"
...
const appName = "Tkchain"

var (
	// DefaultCLIHome sets the default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.tkchaincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.tkchaind")
...
// TkchainApp implements an extended ABCI application. It is an application
...
func NewEthermintApp(
	...
	// use custom Tkchain account for contracts
